...
`).forEach(o=>{const a=o.indexOf(":");if(a>0){const s=o.substring(0,a).trim();let u=o.substring(a+1).trim();u.startsWith("[")&&u.endsWith("]")?(u=u.slice(1,-1),l[s]=u.split(",").map(c=>c.trim()).filter(c=>c)):((u.startsWith('"')&&u.endsWith('"')||u.startsWith("'")&&u.endsWith("'"))&&(u=u.slice(1,-1)),l[s]=u)}}),{frontmatter:l,body:i}}function n_(e){const n=e.match(/^(\d{4}-\d{2}-\d{2})-(.+)\.md$/);return n?{date:n[1],slug:n[2]}:{date:"",slug:e.replace(/\.md$/,"")}}async function Lh(){const e=Object.assign({"/blogs/2010-05-23-cstdlib.md":Nk,"/blogs/2010-06-01-huanghelou.md":Ik,"/blogs/2012-11-22-to-yuanliu.md":bk,"/blogs/2013-10-11-fallnight.md":Lk,"/blogs/2013-10-12-common-life.md":Mk,"/blogs/2013-10-12-genius.md":Fk,"/blogs/2014-09-01-program.md":zk,"/blogs/2014-09-01-vim.md":Rk,"/blogs/2014-11-11-function-language.md":Ak,"/blogs/2014-11-22-nlp.md":Ok,"/blogs/2014-11-25-shell.md":Dk,"/blogs/2014-11-26-deeplearning-toolbox.md":$k,"/blogs/2014-12-12-svm.md":jk,"/blogs/2015-01-26-cnn.md":Bk,"/blogs/2016-05-13-interview-problems.md":Uk,"/blogs/2016-05-14-apue.md":Hk,"/blogs/2016-05-20-mpi.md":Wk,"/blogs/2016-05-24-thread-pool.md":Vk,"/blogs/2016-06-10-os-mode.md":qk,"/blogs/2016-08-05-parallel-training.md":Gk,"/blogs/2018-09-12-sushi.md":Kk,"/blogs/2019-07-20-frontend.md":Qk,"/blogs/2019-07-23-fst.md":Xk,"/blogs/2019-09-10-g2p.md":Yk,"/blogs/2019-09-18-namespace.md":Jk,"/blogs/2020-12-11-ctc-search.md":Zk}),n=[];for(const t in e){const r=e[t],i=t.split("/").pop()||"",{frontmatter:l,body:o}=e_(r),{date:a,slug:s}=n_(i);n.push({slug:s,title:l.title||s,tags:l.tags||[],date:a,content:o})}return n.sort((t,r)=>!t.date&&!r.date?0:t.date?r.date?r.date.localeCompare(t.date):-1:1),n}async function t_(e){return(await Lh()).find(t=>t.slug===e)||null}const r_=()=>{const[e,n]=C.useState([]),[t,r]=C.useState(!0);return C.useEffect(()=>{(async()=>{try{const l=await Lh();n(l)}catch(l){console.error("Failed to load blog posts:",l)}finally{r(!1)}})()},[]),t?S.jsx("div",{className:"blog-container",children:S.jsx("div",{className:"blog-loading",children:"加载中..."})}):S.jsx("div",{className:"blog-container",children:S.jsxs("div",{className:"blog-content",children:[S.jsx("h1",{className:"blog-title",children:"博客文章"}),S.jsx("div",{className:"blog-list",children:e.length===0?S.jsx("div",{className:"blog-empty",children:"暂无文章"}):e.map(i=>S.jsxs(Ct,{to:`/blog/${i.slug}`,className:"blog-item",children:[S.jsxs("div",{className:"blog-item-header",children:[S.jsx("h2",{className:"blog-item-title",children:i.title}),i.date&&S.jsx("span",{className:"blog-item-date",children:i.date})]}),i.tags&&i.tags.length>0&&S.jsx("div",{className:"blog-item-tags",children:i.tags.map((l,o)=>S.jsx("span",{className:"blog-tag",children:l},o))})]},i.slug))})]})})},Do="https://robin1001-1256283475.cos.ap-shanghai.myqcloud.com";function i_(e){return e.replace(/!\[([^\]]*)\]\(([^\)]+)\)/g,(n,t,r)=>{if(r.startsWith("http://")||r.startsWith("https://"))return n;if(r.startsWith("/public/"))return`![${t}](${Do}${r})`;if(r.startsWith("/img/"))return`![${t}](${Do}${r})`;if(r.match(/^\/[^\/]+\/img\//)){const i=r.replace(/^\/[^\/]+/,"/public");return`![${t}](${Do}${i})`}return n})}const l_=()=>{const{slug:e}=Wy(),n=Bs(),[t,r]=C.useState(null),[i,l]=C.useState(!0),o=C.useMemo(()=>t?i_(t.content):"",[t]);return C.useEffect(()=>{(async()=>{if(!e){l(!1);return}try{const s=await t_(e);s?r(s):n("/blog",{replace:!0})}catch(s){console.error("Failed to load blog post:",s)}finally{l(!1)}})()},[e,n]),i?S.jsx("div",{className:"blog-container",children:S.jsx("div",{className:"blog-loading",children:"加载中..."})}):t?S.jsx("div",{className:"blog-container",children:S.jsxs("div",{className:"blog-content",children:[S.jsx(Ct,{to:"/blog",className:"blog-back-link",children:"← 返回博客列表"}),S.jsxs("article",{className:"blog-article",children:[S.jsxs("header",{className:"blog-article-header",children:[S.jsx("h1",{className:"blog-article-title",children:t.title}),S.jsxs("div",{className:"blog-article-meta",children:[t.date&&S.jsxs("span",{className:"blog-article-date",children:["发布时间: ",t.date]}),t.tags&&t.tags.length>0&&S.jsx("div",{className:"blog-article-tags",children:t.tags.map((a,s)=>S.jsx("span",{className:"blog-tag",children:a},s))})]})]}),S.jsx("div",{className:"blog-article-content",children:S.jsx(bh,{children:o})})]})]})}):S.jsxs("div",{className:"blog-container",children:[S.jsx("div",{className:"blog-empty",children:"文章不存在"}),S.jsx(Ct,{to:"/blog",className:"blog-back-link",children:"返回博客列表"})]})},o_=()=>{const{t:e}=qs(),[n,t]=C.useState([]),[r,i]=C.useState(!0),[l,o]=C.useState(new Set);C.useEffect(()=>{(async()=>{try{const c=await fetch("/publications.json");if(c.ok){const d=[...await c.json()].sort((f,v)=>{const x=f.year?parseInt(f.year,10):0,E=v.year?parseInt(v.year,10):0;return x===E?0:x===0?1:E===0?-1:E-x});t(d)}else console.error("Failed to load publications")}catch(c){console.error("Error loading publications:",c)}finally{i(!1)}})()},[]);const a=u=>{const c=new Set(l);c.has(u)?c.delete(u):c.add(u),o(c)},s=(u,c=100)=>u.length<=c?u:u.substring(0,c)+"...";return r?S.jsx("div",{className:"publications-container",children:S.jsx("div",{className:"publications-loading",children:"加载中..."})}):S.jsx("div",{className:"publications-container",children:S.jsxs("div",{className:"publications-content",children:[S.jsx("h1",{className:"publications-title",children:e("publications.title")}),S.jsxs("p",{className:"publications-description",children:[e("publications.description.prefix")," ",S.jsx("a",{href:"https://scholar.google.com/citations?user=IduEkNQAAAAJ",target:"_blank",rel:"noopener noreferrer",className:"publications-scholar-link",children:e("publications.description.link")}),e("publications.description.suffix")&&` ${e("publications.description.suffix")}`]}),S.jsx("div",{className:"publications-list",children:n.length===0?S.jsx("div",{className:"publications-empty",children:"暂无文章"}):n.map((u,c)=>{const p=l.has(c),d=u.authors.length>100,f=d&&!p?s(u.authors):u.authors;return S.jsxs("div",{className:"publication-item",children:[S.jsxs("div",{className:"publication-header",children:[S.jsx("h2",{className:"publication-title",children:u.link?S.jsx("a",{href:u.link,target:"_blank",rel:"noopener noreferrer",className:"publication-title-link",children:u.title}):u.title}),u.year&&S.jsx("span",{className:"publication-year",children:u.year})]}),S.jsxs("div",{className:"publication-authors",children:[S.jsx("span",{className:"publication-label",children:"作者："}),S.jsx("span",{className:"publication-authors-text",children:f}),d&&S.jsx("button",{className:"publication-toggle-authors",onClick:()=>a(c),children:e(p?"publications.collapse":"publications.expand")})]}),u.venue&&S.jsxs("div",{className:"publication-venue",children:[S.jsx("span",{className:"publication-label",children:"会议/期刊："}),S.jsx("span",{className:"publication-venue-text",children:u.venue})]}),u.citations&&u.citations!=="0"&&S.jsxs("div",{className:"publication-citations",children:[S.jsx("span",{className:"publication-label",children:"引用数："}),S.jsx("span",{className:"publication-citations-text",children:u.citations})]})]},c)})})]})})};function a_(){const e=Bs(),n=st();return C.useEffect(()=>{const t=n.search;if(t.startsWith("/?/")){const r=t.slice(3).replace(/~and~/g,"&"),i=r.split("&").find(l=>!l.includes("="))||r.split("&")[0];i&&e(i,{replace:!0})}},[n,e]),null}function s_(){return S.jsx($1,{children:S.jsxs(N1,{children:[S.jsx(a_,{}),S.jsxs("div",{className:"App",children:[S.jsx(j1,{}),S.jsxs(l1,{children:[S.jsx(br,{path:"/",element:S.jsx(Tk,{})}),S.jsx(br,{path:"/blog",element:S.jsx(r_,{})}),S.jsx(br,{path:"/blog/:slug",element:S.jsx(l_,{})}),S.jsx(br,{path:"/publications",element:S.jsx(o_,{})})]})]})]})})}$o.createRoot(document.getElementById("root")).render(S.jsx(tm.StrictMode,{children:S.jsx(s_,{})}));
